...
class ResNet18(Network):
    def setup(self):
        ...
        (self.feed('pool1')
             ...
             .batch_normalization(name='bn2a_branch2b'))
        ...
        (self.feed('bn2a_branch1', 
             ...
             .batch_normalization(name='bn2b_branch2b'))
        ...
        (self.feed('res2b_relu')
             ...
             .batch_normalization(name='bn3a_branch2b'))
        ...
        (self.feed('bn3a_branch1', 
             ...
             .batch_normalization(name='bn3b_branch2b'))
        ...
        (self.feed('res3b_relu')
             ...
             .batch_normalization(name='bn4a_branch2b'))
        ...
        (self.feed('bn4a_branch1', 
             ...
             .batch_normalization(name='bn4b_branch2b'))
        ...
        (self.feed('res4b_relu')
             ...
             .batch_normalization(name='bn5a_branch2b'))
        ...
        (self.feed('bn5a_branch1', 
             ...
             .batch_normalization(name='bn5b_branch2b'))
